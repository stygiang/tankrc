...
- RC input: 6-channel PWM receiver (steering/throttle/button/mode switch + two reserved channels for sonar triggers) wired to the pins listed in `config/pins.h` and adjustable via the serial wizard.
